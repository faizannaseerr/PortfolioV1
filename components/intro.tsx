    ...
    <div className='flex flex-column'>
      ...
      <section ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        <div className='flex items-center justify-center'>
          <div className='relative'> 
            <motion.div initial={{opacity: 0, scale: 0}} animate={{opacity: 1, scale: 1}} transition={{type: "tween", duration: 0.2, delay: 0.2}}>
              <Image src={potrait} alt="Faizan Portrait" width="192" height="192" quality="95" priority={true} className='h-24 w-24 object-cover rounded-full border-[0.35rem] border-white shadow-xl'/>
            </motion.div>
        ...
        <motion.p className='mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl' initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{delay: 0.4}}>
          <span className='font-bold text-[3.5rem] block'> Hi, Faizan here.
          </span> I'm a junior at the {" "}
          ...
          , pursuing an undergraduate computer science degree. My interests lie between design,
        ...
        <motion.div className='flex justify-center items-center gap-2 px-4 text-md font-medium flex-col sm:flex-row' initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{delay: 0.5}}>
          <Link href="#contact" className='cursor-pointer group bg-gray-900 text-white px-7 py-3 flex items-center justify-center rounded-full gap-2 outline-none focus:scale-105 hover:scale-105 hover:bg-gray-950 active:scale-102 transition-all'> Contact me here <BsArrowRight className='opacity-70 group-hover:translate-x-1 transition'/></Link>
  
          <a className='cursor-pointer group bg-white px-7 py-3 flex items-center justify-center rounded-full gap-2 outline-none focus:scale-105 hover:scale-105 active:scale-102 transition-all border border-black/10' href='/CV.pdf' download> Download CV <HiDownload className='opacity-60 group-hover:translate-x-1 transition group-hover:animate-bounce'/> </a>

          <a className='cursor-pointer group bg-white p-4 text-gray-700 flex items-center justify-center rounded-full gap-2 focus:scale-110 hover:scale-110 hover:text-gray-950 active:scale-105 transition-all border border-black/10' href="https://www.linkedin.com/in/faizan-naseerr/" target="_blank"> <BsLinkedin className='group-hover:animate-spin-slow'/> </a>
