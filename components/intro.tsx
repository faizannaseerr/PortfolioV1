...
// 6. add github and deployment icons for projects
  ...
  return (
    <div className='flex flex-column'>
      ...
      <section ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        <motion.p className='mb-10 mt-4 px-4 text-2xl md:text-xl font-medium !leading-[1.5] sm:text-4xl' initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{delay: 0.4}}>
          <span className='font-bold group text-[3.5rem] md:text-[2.5rem] block pl-12 hover:cursor-pointer'> Hello, I'm Faizan. <span className='group-hover:opacity-100 opacity-0 text-[3.5rem] transition-all'>👋🏼</span></span> I'm a junior at the {" "}
        ...
        <motion.div className='flex justify-center items-center gap-2 px-4 text-md md:text-sm font-medium flex-col sm:flex-row' initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{delay: 0.5}}>
