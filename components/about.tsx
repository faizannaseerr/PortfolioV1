...
export default function About() {
  ...
  return (
    <motion.section ref={ref} className='mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 scroll-mt-48' variants={aboutAnimationVariants} initial='initial' whileInView='animate' transition={{delay: 0.3, duration: 0.5}} viewport={{once: true}} id="about">
