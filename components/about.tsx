...
export default function About() {
  ...
  return (
    <motion.section ref={ref} className='mb-28 sm:mt-0 max-w-[45rem] text-sm sm:text-base text-center md:px-0 px-4 sm:leading-8 leading-7 sm:mb-40 scroll-mt-48' variants={aboutAnimationVariants} initial='initial' whileInView='animate' transition={{delay: 0.3, duration: 0.5}} viewport={{once: true}} id="about">
