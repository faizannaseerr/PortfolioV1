...
export default function ProjectOne({
  ...
  return (
    <motion.div ref={ref} initial='initial' whileInView='animate' viewport={{ once: true }} variants={projectAnimationVariants} transition={{ delay: 0.6 }}
      className='hover:bg-gray-100 hover:shadow-md transition-all p-4 rounded-md cursor-pointer'
      ...
      <section className='flex-col flex max-w-[30rem] group'>
        ...
        <Image className='relative rounded-xl backdrop-blur-xl bg-white/30 transition-all' src={imageUrl} alt={title} quality={95} />
